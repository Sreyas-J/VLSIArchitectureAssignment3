...
# Generated on: Sun Feb 16 22:13:01 IST 2025 (Sun Feb 16 16:43:01 UTC 2025)
...
set_log_file fv/AES_CMAC/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/AES_CMAC -revised fv_map
...
read_library -liberty -both /home/cadencea8/Pictures/aes_new/files_rtl3gds/Cadence_design_database_45nm/Cadence_design_database_45nm/synthesis/../lib/slow_vdd1v0_basicCells.lib
...
elaborate_design -golden -root {AES_CMAC} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/AES_CMAC/fv_map.v.gz
elaborate_design -revised -root {AES_CMAC}
...
#add_name_alias fv/AES_CMAC/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/AES_CMAC/rtl_to_fv_map.log
}
