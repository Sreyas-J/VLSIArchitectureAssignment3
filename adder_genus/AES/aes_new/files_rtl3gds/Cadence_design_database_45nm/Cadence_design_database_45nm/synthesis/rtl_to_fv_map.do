...
# Generated on: Tue Mar 25 19:07:42 IST 2025 (Tue Mar 25 13:37:42 UTC 2025)
...
#set_log_file rtl_fv_mapv.log -replace

usage -auto -elapse

# Comparing intermediate 'fv_map' netlist vs. revised netlist.

set_verification_information fv_map_fv_mapv_db

read_implementation_information fv/adder -golden fv_map -revised fv_mapv
...
read_design -verilog95   -golden -lastmod -noelab fv/adder/fv_map.v.gz
elaborate_design -golden -root {adder}

read_design -verilog95   -revised -lastmod -noelab fv_map.v
elaborate_design -revised -root {adder}

#add_name_alias fv/adder/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/adder/fv_mapv.singlebit.original_name.alias.json.gz -revised
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../rtl/aes.v
...
#add_name_alias fv/adder/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _reg((\\\[%w\\\])*(/U\\\$%d)*)$ @1 -type dff dlat -both
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
#analyze_results -logfiles rtl_fv_mapv.log
}
