...
// Generated on: Mar 25 2025 19:07:42 IST (Mar 25 2025 13:37:42 UTC)
...
module adder(clk, a, b, sum, cout);
  ...
  ADDFX1 g4155__2398(.A (t1[7]), .B (t2[7]), .CI (n_12), .CO (n_14), .S (n_15));
  DFFHQX1 \sum_reg[6] (.CK (clk), .D (n_13), .Q (sum[6]));
  ADDFX1 g4157__5107(.A (t1[6]), .B (t2[6]), .CI (n_10), .CO (n_12), .S (n_13));
  DFFHQX1 \sum_reg[5] (.CK (clk), .D (n_11), .Q (sum[5]));
  ADDFX1 g4159__6260(.A (t1[5]), .B (t2[5]), .CI (n_8), .CO (n_10), .S (n_11));
  DFFHQX1 \sum_reg[4] (.CK (clk), .D (n_9), .Q (sum[4]));
  ADDFX1 g4161__4319(.A (t1[4]), .B (t2[4]), .CI (n_6), .CO (n_8), .S (n_9));
  DFFHQX1 \sum_reg[3] (.CK (clk), .D (n_7), .Q (sum[3]));
  ADDFX1 g4163__8428(.A (t1[3]), .B (t2[3]), .CI (n_4), .CO (n_6), .S (n_7));
  DFFHQX1 \sum_reg[2] (.CK (clk), .D (n_5), .Q (sum[2]));
  ADDFX1 g4165__5526(.A (t1[2]), .B (t2[2]), .CI (n_2), .CO (n_4), .S (n_5));
  DFFHQX1 \sum_reg[1] (.CK (clk), .D (n_3), .Q (sum[1]));
  ADDFX1 g4167__6783(.A (t1[1]), .B (t2[1]), .CI (n_0), .CO (n_2), .S (n_3));
  DFFQXL \sum_reg[0] (.CK (clk), .D (n_1), .Q (sum[0]));
  AOI2BB1XL g4169__3680(.A0N (t2[0]), .A1N (t1[0]), .B0 (n_0), .Y (n_1));
  AND2XL g4170__1617(.A (t2[0]), .B (t1[0]), .Y (n_0));
